...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl bg-black fixed-start ms-3   "
        id="sidena-main" style="background-color:#1F8A70 ;">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-dark active bg-gradient-primary" style="background:#BFDB38"
                        href="dashboard.php">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light active " 
                        ...
                        <span class="nav-link-text text-light  ms-1">New Registration</span>
                    </a>
                </li>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg " style="background:#BFDB38; ">
        ...
        <!-- End Navbar -->
        <div class="container-fluid py-4  shadow-lg" style="height:100vh">
            <div class="row ">
