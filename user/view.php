...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <input type="text" name="department" id="search-input" placeholder="Search..." class="form-control-sm bg-light h-100">
  <button type="submit"  name="submit"   id="search-button" class="btn btn-sm btn-success m-auto">Search</button>
</form>
                </ul>
            </div>
            </div>
        ...
        <div class="container-fluid   shadow-lg" style="height:100vh;">
            <div class="col-lg-10  col-md-12  col-sm-8 m-auto">
                <div class="row ">
                    <div class=" col-lg-10  col-md-12  col-sm-8  m-auto"
            ...
            <footer class="footer m-auto w-100" style="position:relative;bottom:0">
